...
export const Layout: React.FC<LayoutProps> = ({ children, currentUser, onLogout, storeName, store, onNavigate, currentView }) => {
  ...
  return (
    <div className="flex h-screen w-full bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200 font-display overflow-hidden">
      {/* Sidebar */}
      <aside
        className={`flex w-64 flex-col justify-between border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-[#161b22] p-4 transition-transform transform ${
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3 px-3 py-4 mt-2 border-t border-gray-200 dark:border-gray-700">
            <div
